	...
	<div class="welcome blank-wp">
		...
		<div class="ms-table ms-fullWidth">
			<div class="tableCol-75">
				...
				<div class="ms-table ms-fullWidth">
					<div class="cell-margin tableCol-50 webPartZoneTitleTopLeft">
						<WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_TopLeft%>" ID="TopLeftRow" />
					</div>
					<div class="cell-margin tableCol-50 webPartZoneTitleTopRight">
				...
				<div class="cell-margin webPartZoneFooter">
